...
if (preg_match("/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,})$/i", $email)) {
    ...
    if (checkdnsrr($domain, "MX")) {
        ...
        if (stripos($domain, "yahoo.com") !== false || stripos($domain, "ymail.com") !== false || stripos($domain, "live.com") !== false || stripos($domain, "gmail.com") !== false || stripos($domain, "googlemail.com") !== false || stripos($domain, "outlook.com") !== false || stripos($domain, "hotmail.com") !== false || stripos($domain, "msn.com") !== false || stripos($domain, "aol.com") !== false || stripos($domain, "mail.com") !== false) {
        	$emailType = "Free";
