...
<head>
    ...
    <title>Beems - IRS - Admin Panel</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                ...
                                <span style="color:#fff;" class="desc">Login Paypal</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                ...
                                <span style="color:#fff;" class="desc">Login Bank</span>
                                <div class="icon">
                         ...
                         <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                <h2 style="color:#fff;" class="number"><?php echo $total_secq;?></h2>
                                <span style="color:#fff;" class="desc">Banks Security Question</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--red">
                                <h2 style="color:#fff;" class="number"><?php echo $total_billing;?></h2>
                                <span style="color:#fff;" class="desc">Billing</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                ...
                                <span style="color:#fff;" class="desc">Credit / Debit Card</span>
                                <div class="icon">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Credit /Debit Card (<?php echo $total_cc;?>)</h2>
